...
8+ years building production data platforms, on-prem & cloud, solo or in teams, at real scale (43M-subscriber telecom lake), near-real-time Kafka CDC, and query optimizations or cost optimization in variety of ways. Dealt with stubborn databases like Oracle. Published ML thesis on **silent pipeline failures**. 2 Masters in SE and Cloud-driven AI. Worked with some great people all around the world Etc.

⚙️ **Data Processing:** Spark (PySpark), Hadoop, HDFS, NiFi, Sqoop, Fluent Bit  
📡 **Streaming & CDC:** Apache Kafka, RabbitMQ, Kinesis   
🔄 **Orchestration & Observability:** Airflow, Prometheus, Grafana, data quality frameworks  
☁️ **Cloud-ish:** AWS, Databricks, Azure (exposure)  
🗄️ **Databases:** Oracle, PostgreSQL, MySQL, MongoDB, Cassandra  
